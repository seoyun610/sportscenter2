...
<head> 
	...
	<div class="bbs">
		<div class="view">
            ...
            <div>
				<div>
				<a href="adminSubject.do" class="btn">목록</a>
               	<a href="/subject/edit.do?subjectid=${vo.subjectid}" class="btn">수정</a>
                <a href="/subject/delete.do?subjectid=${vo.subjectid}" class="btn">삭제</a>
            	</div>
			</div>
         </div>
     </div>
