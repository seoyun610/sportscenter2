	...
	<div class="page-content-wrapper border">
		<div class="row mb-3 mr-2 ml-1">
			<div class="col-12 d-sm-flex justify-content-between align-items-center mb-4">
				<h2 class="h3 mb-2 mb-sm-0"> 공지 게시판 </h2>
				<input type="button" class="btn btn-primary mb-0" onClick="location.href='/notice/write.do'" value="작성하기">
			</div>
	<!-- Card START -->
		<div class="card bg-transparent border">
			...
			<div class="card-header bg-light border-bottom">
				...
				<div class="row mb-0 align-items-center">
					<form method="get" name="searchForm" id="searchForm" action="/admin/adminNotice.do">
					    <div class="d-flex align-items-center" style="width: 100%;">
					        ...
					        <input class="form-control bg-body me-2" type="text" placeholder="검색하고자 하는 내용을 입력하세요" aria-label="Search" name="searchWord" value="${NoticeVO.searchWord}" style="flex-grow: 1;">
					...
					<table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
						...
						<tr style="height: 65px;">
							...
							<td>
								<div class="align-items-center">
									<h5 class="mb-0 fw-light"><a href="adminNoticeView.do?noticeid=${vo.noticeid}">${vo.noticetitle } </a></h5>
								</div>
							</td>
							<td>
								<div class="align-items-center">
									<h5 class="mb-0 fw-light"> ${vo.adminname }</h5>
								</div>
							</td>
							<td>
								<div class="align-items-center">
									<h5 class="mb-0 fw-light">${vo.noticeregcnt }</h5>
								</div>
							</td>
							<td class="date">
								<div class="align-items-center">
									<h5 class="mb-0 fw-light"><fmt:formatDate value="${vo.noticedate }" pattern="YYYY-MM-dd"/></h5>
								</div>
							</td>
						</tr>
						</c:forEach>	
						...
						<div class="card-footer bg-transparent pt-0">
							...
							<div class="d-sm-flex justify-content-sm-between align-items-sm-center">
								<!-- Content -->
								<p class="mb-0 text-center text-sm-start">	${NoticeVO.page }/${map.totalPage }페이지 </p>
								<!-- Pagination -->
								<nav class="d-flex justify-content-center mb-0" aria-label="navigation">
									<ul class="pagination pagination-sm pagination-primary-soft d-inline-block d-md-flex rounded mb-0">
										<c:if test="${map.prev }">
										<li class="page-item mb-0"><a class="page-link" href="/admin/adminNotice.do?page=${map.startPage-1 }&searchWord=${PayVO.searchWord}" tabindex="-1"><i class="fas fa-angle-left"></i></a></li>
										</c:if>
	                					...
	                					<c:if test="${p != NoticeVO.page}">
	                    			 		<li class="page-item mb-0"><a class="page-link" href='/admin/adminNotice.do?page=${p}&searchWord=${NoticeVO.searchWord}'>${p}</a></li>
	                					</c:if>
	                					</c:forEach>
	                					<c:if test="${map.next }">
										<li class="page-item mb-0"><a href="/admin/adminNotice.do?page=${map.endPage+1 }&searchWord=${NoticeVO.searchWord}" class="page-link"><i class="fas fa-angle-right"></i></a></li>
										</c:if>
									</ul>
								</nav>
							</div>
