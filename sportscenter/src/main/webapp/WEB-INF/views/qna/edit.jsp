...
<body>
        <div class="sub">
            <div class="size">
                ...
                <input type="hidden" name="qnaid" value="${vo.qnaid}">
                    <table>
                        <tbody>
                        <tr>
                            <th>제목</th>
                            <td>
                                <input type="text" name="qnatitle" id="title" class="wid100" value="${vo.qnatitle }"/>
                            </td>
                        </tr>
                        <tr>
                            <th>내용</th>
                        ...
                        <tr>
                            <th>첨부파일</th>
                            <td>
                            	<c:if test="${not empty vo.qnafilename_org}">
