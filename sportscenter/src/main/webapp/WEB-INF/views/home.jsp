			...
			<!-- Nav Main menu START -->
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle active" href="#" id="demoMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">종목/ 안내</a>
						<ul class="dropdown-menu" aria-labelledby="demoMenu">
							...
							<li> <a class="dropdown-item" href="/subject/usageInfo.do">수강신청</a></li>
						</ul>
					</li>

					<!-- Nav 수강신청 -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">수강신청</a>
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							<!-- Dropdown submenu -->
							<li class="dropdown-submenu dropend">
								<a class="dropdown-item active" href="/class/list.do">온라인 수강 신청</a>
							</li>
						</ul>
					</li>
					...
					<!-- Nav 커뮤니티 -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="accounntMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">커뮤니티</a>
	...
	<div class="container">
		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
				...
				<!-- Title -->
				<h1 class="mb-0 display-6">스포츠 문화 센터
