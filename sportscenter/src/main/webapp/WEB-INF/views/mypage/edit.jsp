            ...
            <div class="size">
                ...
                <table class="board_write">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>비밀번호</th>
                            <td><input type="password" name="pwd" id="pwd" placeholder="비밀번호는 숫자, 영문 조합으로 8자 이상으로 입력해주세요." style="float:left;"> <span class="ptxt"></span> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <input type="text" name="addr" id="addr" value="${vo.addr }"  maxlength="15" style="float:left;" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>
