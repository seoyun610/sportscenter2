	...
	<div class="container">
		<div class="row">
			<div class="col-12" style="font-family: 'Noto Sans KR', sans-serif;">
				...
				<p style="font-size: 19px; color: grey;">스피닝은 실내사이클과 음악, 조명, 신나는 댄스가 어우러진 유산소 운동으로 다이어트 및 스트레스 해소에 탁월합니다.</p>
    ...
    <thead class="border-0">
	    ...
	    <tbody class="border-top-0" style="font-family: 'Noto Sans KR', sans-serif; text-align: center; vertical-align: middle;">
					        	...
					        	<tr>
						            ...
						            <td>
						                <span class="text-body">성인: 65,000</span><br>
						            </td>
						        ...
						        <tr>
						            ...
						            <td>
						                 <span class="text-body">성인: 50,000</span><br>
						            </td>
							...
							<P style="font-size: 19px; color: grey;">스피닝은 고정된 바이크 위에서 페달을 밝으며 신나는 음악에 맞춰 율동을 하는 다이나믹한 운동입니다. 체지방 감량과 근지구력 강화에 매우 효과적이며 다이어트는 물론 스트레스를 해소할 수 있습니다.</P>
							<h3 style="font-weight: bold; line-height:250%; letter-spacing : 0.02em;">
							 <img src="/resources/images/element/circle.png" alt="동그라미 이미지" style="width: 30px; height: 30px; margin-right: 10px;">
							시간당 높은 체지방 감량 효과
							</h3>
							<P style="font-size: 19px; color: grey;">스피닝은 실내 사이클과 음악, 조명, 신나는 댄스가 어우러져 시간당 최고의 체지방 감량 효과를 누릴 수 있습니다. 짧은 시간에 빠른 다이어트를 원하는 분들에게 추천합니다.</P>
