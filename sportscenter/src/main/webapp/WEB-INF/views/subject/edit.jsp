	...
	<div class="sub">
		...
		<div class="bbs">
			<form method="post" name="frm" id="frm" action="update.do" enctype="multipart/form-data" >
				<input type="hidden" name="noticeid" value="${vo.subjectid}">
				<table>
					<tbody>
						<tr>
							<th>제목</th>
                            <td>
                                <input type="text" name="subjecttype" id="title" class="wid100" value="${vo.subjecttype }"/>
                            </td>
                        </tr>
                        <tr>
                            <th>내용</th>
                            <td>
                                <textarea name="subjectcontent" id="content" style="width:100%;">${vo.subjectcontent }</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th>첨부파일</th>
